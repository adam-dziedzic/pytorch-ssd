...
if len(sys.argv) < 4 and len(sys.argv) > 1:
    ...
    net_type = 'vgg16-ssd'
    # model_path = os.path.join('models', 'mobilenet-v1-ssd-mp-0_675.pth')
    model_path = os.path.join('models', 'vgg16-ssd-mp-0_7726.pth')
    label_path = os.path.join('models', 'voc-model-labels.txt')
